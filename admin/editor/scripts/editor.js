	...
	for(var i=0;i<this.buttonMap.length;i++)
		...
		switch(sButtonName)
			...
			case "Bookmark":
				...
				break;
			case "Hyperlink":
				if(this.btnHyperlink)sHTMLIcons+=this.writeIconStandard("btnHyperlink"+this.oName,this.oName+".hide();modelessDialogShow('"+this.scriptPath+"hyperlink.php',380,255)","btnHyperlink.gif",getTxt("Hyperlink"));
				break;
			case "CustomTag":
