...
function InnovaEditorUtil()
	...
	if(this.langDir=="modera")
	document.write("<scr"+"ipt src='"+this.scriptPathLang+"modera.php?type=editor_lang'></scr"+"ipt>");
	/*** /Localization ***/
    ...
    for(var i=0;i<this.buttonMap.length;i++)
        ...
        switch(sButtonName)
            ...
            case "Bookmark":
                ...
                break;
            case "Hyperlink":
                if(this.btnHyperlink)sHTMLIcons+=this.writeIconStandard("btnHyperlink"+this.oName,"modelessDialogShow('"+this.scriptPath+"hyperlink.php',420,205)","btnHyperlink.gif",getTxt("Hyperlink"));
                break;
            case "CustomTag":
...
function moveTagSelector()
    ...
    */
    var sTagSelTop="<table unselectable=on ondblclick='"+this.oName+".moveTagSelector()' width='100%' cellpadding=0 cellspacing=0><tr style='background:#E4E4E4;font-family:arial;font-size:10px;color:black;'>"+
    ...
    var sTagSelBottom="<table unselectable=on ondblclick='"+this.oName+".moveTagSelector()' width='100%' cellpadding=0 cellspacing=0><tr style='background:#E4E4E4;font-family:arial;font-size:10px;color:black;'>"+
        "<td id=idElNavigate"+ this.oName +" style='padding:1px;width:"+nWidth+"px' valign=top>&nbsp;</td>"+
        "<td align=right valign=top nowrap>"+
        "<span id=idElCommand"+ this.oName +" unselectable=on style='display:none;text-decoration:underline;cursor:pointer;padding-right:5px;' onclick='"+this.oName+".removeTag()'>"+getTxt("Remove Tag")+"</span>"+
        "</td></tr></table>";
...
function modelessDialogShow(url,width,height)
    ...
    window.open(url, "", "dependent=yes,scrollbars=yes,width="+width+"px,height="+height+",left="+left+",top="+top);
    }
...
function modalDialogShow(url,width,height)
    ...
    var left = screen.availWidth/2 - width/2;
    var top = screen.availHeight/2 - height/2;
    oUtil.activeModalWin = window.open(url, "", "width="+width+"px,height="+height+",scrollbars=yes,left="+left+",top="+top);
...
function lineBreak1(tag) //[0]<TAG>[1]text[2]</TAG>
	{
	arrReturn = ["\n","",""];
	if( tag=="A"||tag=="B"||tag=="SPAN"||tag=="CITE"||tag=="CODE"||tag=="EM"||
