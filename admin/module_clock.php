...
$txtf = new Text($language2, "module_clock");

// ##############################################################
// ##############################################################

$table = "module_clock"; // SQL table name to be administered
...
$general = array(
	...
	"max_entries" => 50,
	"sort" => "sort_order ASC" // default sort to use
