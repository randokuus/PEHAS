...
$txtf = new Text($language2, "module_isic_application_reject_reason");

// ##############################################################
// ##############################################################

$table = "module_isic_application_reject_reason"; // SQL table name to be administered
...
$fields = array(
    ...
    "return_collateral" => $txtf->display("return_collateral"),
    "return_cost" => $txtf->display("return_cost"),
);
...
function external() {
    ...
    $adm->assignProp("return_collateral", "type", "checkbox");
    $adm->assignProp("return_collateral", "list", array("0" => $txt->display("no"), "1" => $txt->display("yes")));
    
    $adm->assignProp("return_cost", "type", "checkbox");
    $adm->assignProp("return_cost", "list", array("0" => $txt->display("no"), "1" => $txt->display("yes")));
}
