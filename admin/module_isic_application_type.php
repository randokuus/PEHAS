...
$txtf = new Text($language2, "module_isic_application_type");

// ##############################################################
// ##############################################################

$table = "module_isic_application_type"; // SQL table name to be administered
...
function external() {
    ...
    $adm->assignProp("short_name", "extra", $txtf->display("short_name_extra"));
}
