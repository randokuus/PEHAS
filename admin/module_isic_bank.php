...
$txtf = new Text($language2, "module_isic_bank");

// ##############################################################
// ##############################################################

$table = "module_isic_bank"; // SQL table name to be administered
...
$fields = array(
    ...
    "show_in_filter" => $txtf->display("show_in_filter"),
...
function external() {
    ...
    $adm->assignProp("show_in_filter", "type", "checkbox");
    $adm->assignProp("show_in_filter", "list", array("0" => $txt->display("no"), "1" => $txt->display("yes")));
