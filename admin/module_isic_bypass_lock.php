...
$txtf = new Text($language2, "module_isic_bypass_lock");

// ##############################################################
// ##############################################################

$table = "module_isic_bypass_lock"; // SQL table name to be administered
...
function external() {
	...
	$adm->assignExternal("school_id", "module_isic_service_location", "id", "name", " ORDER BY name", false);
}
