...
$table = "module_isic_card_fieldset"; // SQL table name to be administered
...
$general = array(
    ...
    "max_entries" => 50,
    "sort" => "column_order, sort_order, name" // default sort to use
...
$fields = array(
    ...
    "column_order" => $txtf->display("column"),
