...
$txtf = new Text($language2, "module_isic_card_range");

// ##############################################################
// ##############################################################

$table = "module_isic_card_range"; // SQL table name to be administered
...
$fields = array(
    ...
    "range_beg" => $txtf->display("range_beg"),
    "range_end" => $txtf->display("range_end"),
    "last_number" => $txtf->display("last_number"),
);
...
function external() {
	...
	$adm->assignExternal("card_type", "module_isic_card_type", "id", "name", " WHERE number_type = 2 ORDER BY name", false);
}
