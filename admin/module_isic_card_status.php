...
$txtf = new Text($language2, "module_isic_card_status");

// ##############################################################
// ##############################################################

$table = "module_isic_card_status"; // SQL table name to be administered
...
function external() {
	...
	$adm->assignProp("action_type", "type", "select");
	$adm->assignProp("action_type", "list", array(
	   "0" => $txtf->display("action_type0"), 
	   "1" => $txtf->display("action_type1"), 
	   "2" => $txtf->display("action_type2"), 
	   "3" => $txtf->display("action_type3"), 
	   "4" => $txtf->display("action_type4"),
	   "5" => $txtf->display("action_type5"),
	   "6" => $txtf->display("action_type6"))
    );
    ...
    $adm->assignProp("should_return", "type", "checkbox");
    $adm->assignProp("should_return", "list", array("0" => $txt->display("no"), "1" => $txt->display("yes")));
}
