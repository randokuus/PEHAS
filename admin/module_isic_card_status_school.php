...
$table = "module_isic_card_status_school"; // SQL table name to be administered
...
function external() {
	...
	$adm->assignExternal("status_id", "module_isic_card_status", "module_isic_card_status.id", "CONCAT(module_isic_card_type.name, ': ', module_isic_card_status.name) AS name", " , module_isic_card_type WHERE module_isic_card_status.card_type = module_isic_card_type.id ORDER BY name", false);
