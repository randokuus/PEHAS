...
$txtf = new Text($language2, "module_isic_card_trueb_import");
...
function saveChipNumber ($chip_number, $isic_number) {
    ...
    $sql = "SELECT id FROM `module_isic_card` WHERE `isic_number` = '" . mysql_escape_string($isic_number) . "'";
            ...
            if ($fp = fopen($filename, "rb")) {
                ...
                while (!feof($fp)) {
                    ...
                    if ($t_line[0]) {
                        ...
                        $import_log .= "<tr><td>" . $line_count . ".</td><td>" . $t_line[0] . " -> " . $t_line[1] . "</td><td>" . $res . "</td></tr>\n";
                    }
                }
