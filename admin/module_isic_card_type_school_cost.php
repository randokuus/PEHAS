...
$table = "module_isic_card_type_school_cost"; // SQL table name to be administered
...
$fields = array(
    ...
    "beg_date" => $txtf->display("beg_date"),
    "end_date" => $txtf->display("end_date"),
    "sum_card" => $txtf->display("sum_card"),
    "sum_period" => $txtf->display("sum_period"),
);
...
function external() {
	...
	$adm->assignExternal("type_id", "module_isic_card_type", "module_isic_card_type.id", "module_isic_card_type.name", " ORDER BY name", false);
