...
$general = array(
    ...
    "button" => $txtf->display("create_user_accounts"),
    "max_entries" => 30,
...
if ($do == "update" && $id) {
    $export_log .= "<tr>\n";
    $export_log .= "<th>Updated</th>\n";
    $export_log .= "<th>Inserted</th>\n";
    $export_log .= "<th>None</th>\n";
    $export_log .= "</tr>\n";
    $isic = IsicCommon::getInstance();
    $stat = $isic->createAllUserAccounts($school_id, $bind_user);
    $export_log .= "<tr>\n";
    $export_log .= "<td>" . ($stat[1]) . "</td>\n";
    $export_log .= "<td>" . ($stat[2]) . "</td>\n";
    $export_log .= "<td>" . ($stat[0]) . "</td>\n";
    $export_log .= "</tr>\n";
}
/* end DB writing part */
