...
$txtf = new Text($language2, "module_isic_card_validities");

// ##############################################################
// ##############################################################

$table = "module_isic_card_validities"; // SQL table name to be administered
...
$fields = array(
    ...
    "user_status_id" => $txtf->display("status"),
    "user_status_active" => $txtf->display("active"),
    "added" => $txtf->display("added"),
    "modified" => $txtf->display("modified"),
);
...
function external() {
    ...
    $adm->assignProp("user_status_active", "type", "checkbox");
    $adm->assignProp("user_status_active", "list", array("0" => $txt->display("no"), "1" => $txt->display("yes")));
