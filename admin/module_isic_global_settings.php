...
$txtf = new Text($language2, "module_isic_global_settings");

// ##############################################################
// ##############################################################

$table = "module_isic_global_settings"; // SQL table name to be administered
...
$disp_fields = array(
  $idfield => $txtf->display("id"), // if you want to display the ID as well,
  "description" => $txtf->display("description"),
  "value" => $txtf->display("value"),
  );
