...
$txtf = new Text($language2, "module_isic_service_device");

// ##############################################################
// ##############################################################

$table = "module_isic_service_device"; // SQL table name to be administered
...
$fields = array(
    ...
    "device_id" => $txtf->display("device_id"),
...
function external() {
	...
	$adm->assignExternal("type_id", "module_isic_service_type", "id", "name", " ORDER BY name", false);
