...
$txtf = new Text($language2, "module_messages_send_queue");

// ##############################################################
// ##############################################################

$table = "module_messages_send_queue"; // SQL table name to be administered
...
$fields = array(
    "message_type" => $txtf->display("message_type"),
...
function external() {
    ...
    $adm->assignProp("message_type", "type", "select");
    $adm->assignProp("message_type", "list", array("sms" => $txtf->display("message_type_sms")));
