<?php defined("MODERA_KEY")|| die(); ?>            <?php if(isset($data["MESSAGE"]) && is_array($data["MESSAGE"])){ foreach($data["MESSAGE"] as $_foreach["MESSAGE"]){ ?>
            ...
            <form method="post" action="<?php echo $data["SELF"]; ?>" name="vorm" class="jNice">
            ...
            <div class="box">
                <div class="inner">
                    ...
                    <!--tableWrap-->
                    <div class="tableWrap">
                        <table class="tList tWide">
                            <tr>
								<th><?php echo $this->getTranslate("module_isic_card|row"); ?></th>
								...
								<th><?php echo $this->getTranslate("module_isic_card|confirm"); ?></th>
                            </tr>
            ...
            <!--/box-->
            <div class="wButtons tListSubmit">
