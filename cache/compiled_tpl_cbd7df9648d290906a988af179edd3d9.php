                        ...
                        <div class="filterTable fourCols">
                            ...
                            <?php echo $_foreach["SEARCH"]["HIDDEN"]; ?>
                                ...
                                <div class="tCol">
                                    ...
                                    <div class="tLine">
                                        <label for=""><?php echo $this->getTranslate("module_isic_user|course"); ?>:</label>
                                        <?php echo $_foreach["SEARCH"]["FIELD_FILTER_COURSE"]; ?>
                                    </div>
                                    <div class="tLine">
                                        <label for=""><?php echo $this->getTranslate("module_isic_user|class"); ?>:</label>
                                        <?php echo $_foreach["SEARCH"]["FIELD_FILTER_CLASS"]; ?>
                                    </div>
                                </div>
                                <div class="tCol">
                                    <div class="tLine">
