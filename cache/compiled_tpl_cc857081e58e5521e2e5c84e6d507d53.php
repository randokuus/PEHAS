                    ...
                    <div class="boxcontent">
                        ...
                        <div class="filterTable fourCols">
                            ...
                            <?php echo $_foreach["SEARCH"]["HIDDEN"]; ?>
                                ...
                                <div class="tCol">
                                    <div class="tLine">
                                        <label for=""><?php echo $this->getTranslate("module_isic_card|person_class"); ?>:</label>
                                        <?php echo $_foreach["SEARCH"]["FIELD_FILTER_PERSON_CLASS"]; ?>
                                    </div>
                                    <div class="tLine">
                ...
                <div class="inner">
                    ...
                    <th>&nbsp;</th>
                            ...
                            <tr>
						        ...
						        <td><a href="<?php echo $_foreach["DATA"]["URL_DETAIL"]; ?>"><?php echo $_foreach["DATA"]["DATA_PERSON_CLASS"]; ?></a></td>
