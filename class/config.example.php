...
define("COOKIE_URL", "isic.peterson.dev.modera.net"); // domain where site is running, for example "www.mysite.com"
...
define("MODERA_KEY", "A616-78D4-0EE0-489E-6270-5B44-A399-777B"); // modera product key

// Database access properties
define("DB_TYPE", "mysql");  // DB type, mysql supported
define("DB_USER", "peterson"); // DB username
define("DB_PASS", "..."); // DB password
define("DB_HOST", "127.0.0.1"); // host to connect to, localhost by default
define("DB_DB", "peterson_isic"); // DB name to connect to

//full path, where the site is installed
define("SITE_PATH", "/home/peterson/sites/isic.htdocs"); // no trailing slash - /var/www/www.mysite.com/site
// URL where the site is running
define("SITE_URL", "http://isic.peterson.dev.modera.net"); // no trailing slash - http://www.mysite.com/site

// ISIC-specific constants (defined in database now)
/*
...
define("TESTERS_EMAILS", DEVELOPERS_EMAILS . ",rene.randver@minukool.ee,liisa.alop@minukool.ee");  // mail captures are sent to this comma-separated list of email addresses
define("LOG_PROGRAM_FLOW", false);  // whether should the program flow be logged or not (warning!! turning it on makes the system 10 times slower)
...
define('AUTH_CHECK_USER_ACCOUNT_RECORD', 0); // checking if user record exists before doing external authentication
