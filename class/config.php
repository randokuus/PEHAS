...
define("COOKIE_URL", "dev.personalikaart.ee"); // domain where site is running, for example "www.mysite.com"
define("COOKIE_SECURE", false); // secure site or not, boolean value [true|false]
...
define("MODERA_KEY", "4094-73EC-29D9-8233-CC8F-332A-ED9C-9BAB"); // modera product key

// Database access properties
define("DB_TYPE", "mysql");  // DB type, mysql supported
define("DB_USER", "ksadmin"); // DB username
define("DB_PASS", "KS!486dminA"); // DB password
define("DB_HOST", "localhost"); // host to connect to, localhost by default
define("DB_DB", "pehas"); // DB name to connect to

//full path, where the site is installed
define("SITE_PATH", "/var/www/test.pehas.ee"); // no trailing slash - /var/www/www.mysite.com/site
// URL where the site is running
define("SITE_URL", "http://dev.personalikaart.ee"); // no trailing slash - http://www.mysite.com/site
...
define('ISIC_CRYPTO_KEY', '238rt49ghofnejq0+3rht480i');
