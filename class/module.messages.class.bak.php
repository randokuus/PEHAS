...
//        }
    ...
    private function initAddModFields($txt, $messageData)
    {
        ...
        $fields = array(
            "send_type" => array("radio", 0, 0, $this->vars["send_type"], $this->getSendTypes($txt), 'onClick="refreshFields();"', ""),
            "school_id" => array("select", 0, 0, $this->vars["school_id"], $this->getSchoolList(), "", ""),
            "title" => array("textinput", 60, 0, $this->vars["title"], "", "", ""),
            "text" => array("textfield", 60, 5, $this->vars["text"], "", "", ""),
            "recipient_type" => array("radio", 0, 0, $this->vars["recipient_type"], $this->getRecipientTypes($txt), 'onClick="refreshRecipientFields();"', ""),
            "faculty" => array("textinput", 60, 0, $this->vars["faculty"], "", 'onblur="refreshClientList();"', ""),
            "group" => array("select2", 10, 0, $this->vars["group"], $this->getGroupList(), "onChange=\"refreshClientList();\"", ""),
            "client" => array("select2", 10, 0, $this->vars["client"], $this->getClientList($tClients), "", ""),
            "person_numbers" => array("textfield", 20, 20, $this->vars["person_numbers"], '', "", ""),
        );
        return $fields;
    }
