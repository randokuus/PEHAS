...
class XMLToArray {
    ...
    function parse($xmlstring="") {
        ...
        xml_parse($this->parser, $xmlstring) or die(sprintf("XML error: %s at line %d", xml_error_string(xml_get_error_code($this->parser)), xml_get_current_line_number($this->parser)));
