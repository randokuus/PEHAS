...
$dbApps = IsicDB::factory('Applications');

echo "<pre>\n";
echo date('H:i:s') . "\n";

$days = intval($dbSettings->getRecord('unfinished_application_delete_days'));
$curTime = time();
...
echo 'Deleted: ' . $dbApps->deleteUnfinishedApplications($date) . "\n";
