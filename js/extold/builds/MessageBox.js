...
Ext.MessageBox = function(){
    ...
    var bodyEl, msgEl, textboxEl, textareaEl, progressEl, progress2El, pp, pp2;
        ...
        getDialog : function(){
           if(!dlg){
                ...
                bodyEl = dlg.body.createChild({
                    tag:"div",
                    html:'<span class="ext-mb-text"></span><br /><input type="text" class="ext-mb-input" /><textarea class="ext-mb-textarea"></textarea><div class="ext-mb-progress-wrap"><div class="ext-mb-progress"><div class="ext-mb-progress-bar 1">&#160;</div></div></div><div class="ext-mb-progress-wrap"><div class="ext-mb-progress"><div class="ext-mb-progress-bar 2">&#160;</div></div></div>'
                });
...
// progress 2
                progress2El = Ext.get(bodyEl.dom.childNodes[5]);
...
Ext.Msg.show({
   ...
   animEl: 'addAddressBtn'
        ...
        show : function(options){
            ...
            progress2El.setDisplayed(opt.progress2 === true);
