...
$count = 0;
$sql = "SELECT person_number, type_id, count(id) as tot FROM module_isic_application WHERE not (state_id in (6, 7)) group by person_number, type_id order by tot desc";
$sq->query($db, $sql);
