...
echo date('H:i:s');
$sql = "SELECT `isic_school`, `user_status_id`, automatic, count(*) AS combo_count FROM `module_user_groups` group by isic_school, user_status_id, automatic ORDER BY combo_count DESC";
