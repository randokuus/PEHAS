...
$sql = "
    SELECT
        ...
        module_isic_card.delivery_addr1,
        module_isic_card.delivery_addr2,
        module_isic_card.delivery_addr3,
        module_isic_card.delivery_addr4,
        module_isic_card.id,
...
//                    print_r($statusRecord);
        ...
        $cardRecord = $dbApps->getRecord($row['id']);
